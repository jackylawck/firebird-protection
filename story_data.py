...
STORY_1_SCENES = {
    "1_START": {
        ...
        "sfx": "🚨 嗚哇！WEE WOO!", 
        "images": [
            "https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Lego_Color_Bricks.jpg/800px-Lego_Color_Bricks.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Full_Moon_Luc_Viatour.jpg/800px-Full_Moon_Luc_Viatour.jpg"
        ],
    ...
    "3_A": {
        ...
        "sfx": "🎰 叮噹！DING DONG!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Lego_minifigures.jpg/800px-Lego_minifigures.jpg"],
    ...
    "3_B": {
        ...
        "sfx": "🍬 咕嚕！GLUG!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Marshmallows.jpg/800px-Marshmallows.jpg"],
    ...
    "3_C": {
        ...
        "sfx": "🍔 嗷嗚！NOM NOM!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/RedDot_Burger.jpg/800px-RedDot_Burger.jpg"],
    ...
    "4_A": {
        ...
        "sfx": "🍌 哈哈！HAHA!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Banana-Single.jpg/800px-Banana-Single.jpg"],
    ...
    "4_B": {
        ...
        "sfx": "🍦 呼呼！BRRR!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Ice_Cream_dessert_02.jpg/800px-Ice_Cream_dessert_02.jpg"],
    ...
    "4_C": {
        ...
        "sfx": "🍌 哎呀！WHOOPS!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Banana_Peel_-_Garten.jpg/800px-Banana_Peel_-_Garten.jpg"],
    ...
    "5_A": {
        ...
        "sfx": "✨ 閃閃！SPARKLE!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Sparkler.jpg/800px-Sparkler.jpg"],
    ...
    "6_A": {
        ...
        "sfx": "🎉 耶！HOORAY!", 
        "images": [
            "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Confetti_burst.jpg/800px-Confetti_burst.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Lego_Color_Bricks.jpg/800px-Lego_Color_Bricks.jpg"
        ],
...
STORY_2_SCENES = {
    "1_START": {
        ...
        "sfx": "🦖 吼吼！ROAR!", 
        "images": [
            "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Tyrannosaurus_rex_museum_model.jpg/800px-Tyrannosaurus_rex_museum_model.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/Roller_coaster_fun.jpg/800px-Roller_coaster_fun.jpg"
        ],
    ...
    "2_A": {
        ...
        "sfx": "💦 嘩啦！SPLASH!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Water_drop_impact_on_water_surface_-_a.jpg/800px-Water_drop_impact_on_water_surface_-_a.jpg"],
    ...
    "2_B": {
        ...
        "sfx": "🪫 嗶嗶... BEEP...", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Triceratops_horridus_monterey.jpg/800px-Triceratops_horridus_monterey.jpg"],
    ...
    "2_C": {
        ...
        "sfx": "🪺 哎呀！OUCH!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Bird_nest_with_eggs.jpg/800px-Bird_nest_with_eggs.jpg"],
    ...
    "3_A": {
        ...
        "sfx": "🦖 吼吼！ROAR!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Tyrannosaurus_rex_museum_model.jpg/800px-Tyrannosaurus_rex_museum_model.jpg"],
    ...
    "3_B": {
        ...
        "sfx": "💩 噗滋！SQUISH!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Mud_puddle.jpg/800px-Mud_puddle.jpg"],
    ...
    "3_C": {
        ...
        "sfx": "🕺 咚咚！BUMP BUMP!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Tyrannosaurus_rex_museum_model.jpg/800px-Tyrannosaurus_rex_museum_model.jpg"],
        "story_tc": "奇怪！樂園里的恐龍竟然全部排好隊，在跳搞笑的扭屁股舞！", "story_en": "Weird! All the dinosaurs in the park are lined up, dancing a hilarious butt-wiggling dance!",
    ...
    "4_A": {
        ...
        "sfx": "🪄 嘻嘻！HEE HEE!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Wizard_hat.jpg/800px-Wizard_hat.jpg"],
    ...
    "4_B": {
        ...
        "sfx": "🍎 砰砰！BAM BAM!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Red_Apple.jpg/800px-Red_Apple.jpg"],
    ...
    "5_C": {
        "title_tc": "第 5 頁：發動搞笑絕招！(食物系)", "title_en": "Page 5: Hilarious Ultimate Move! (Food)",
        "sfx": "🍉 咕嚕！YUMMY!", 
        "images": ["https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Watermelon_slice.jpg/800px-Watermelon_slice.jpg"],
    ...
    "6_A": {
        ...
        "sfx": "🦆 呱呱！QUACK!", 
        "images": [
            "https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/Rubber_duckies_SO.jpg/800px-Rubber_duckies_SO.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Confetti_burst.jpg/800px-Confetti_burst.jpg"
        ],
    ...
    "6_C": {
        "title_tc": "第 6 頁：大結局！(大食會結局)", "title_en": "Page 6: The End! (Full Tummy Ending)",
        "sfx": "🍉 好飽！FULL!", 
        "images": [
            "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Watermelon_slice.jpg/800px-Watermelon_slice.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Confetti_burst.jpg/800px-Confetti_burst.jpg"
        ],
...
STORIES = {
    "Story1": {
        ...
        "name_en": "Firebird 1: Toy Planet",
        "nodes": STORY_1_SCENES
    },
    "Story2": {
        "name_tc": "📘 火鷹俠 2：恐龍樂園大暴走",
        "name_en": "Firebird 2: Dinosaur Park",
